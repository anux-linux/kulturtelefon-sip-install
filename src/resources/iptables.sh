...
#remove ufw
verbose "Configuring IPTables - Remove UFW"
ufw reset
ufw disable
...
#flush iptables
verbose "Configuring IPTables - Flush existing rules"
...
verbose "Configuring IPTables - Adding rules"
...
verbose "Configuring IPTables - Install iptables-persistent to save rules"
